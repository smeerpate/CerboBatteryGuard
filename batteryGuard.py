# je kan deze code downloaden op de Cerbo met: wget https://raw.githubusercontent.com/smeerpate/CerboBatteryGuard/refs/heads/main/batteryGuard.py
import dbus
import time
import logging
import threading
...
def readButton():
    try:
        ...
        logging.error(f"Fout bij lezen knop: {e}")
        return False
